                ...
                <div class="row justify-content-md-center">
                    <div class="col-xl-4 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="../HelloArabDash/package/cpackages.php">
                    ...
                    <div class="col-xl-4 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">Update Package</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="../HelloArabDash/package/upackages.php">
              <span class="float-left">Click Here</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-xl-4 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="../HelloArabDash/package/vpackages.php">
              <span class="float-left">Click Here</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
                    ...
                    <div class="col-xl-4 col-sm-6 mb-3">
                        <div class="card text-white bg-danger o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">Disable Package</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="../HelloArabDash/package/dpackages.php">
              <span class="float-left">Click Here</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
